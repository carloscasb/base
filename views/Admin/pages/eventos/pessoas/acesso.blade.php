...
<input type="button" value="+ Cadastra " onClick="mostra('cadastro')"/>
   ...
   <div class="card">
            <div class="card-body">
            <form action="{{ route('eventos.pessoas.attach', $evento->id) }}" class="form" method="POST" >
@csrf
...
<div class="form-group col-md-6">
    ...
    <div class="form-group col-md-2">
      <label for="inputCity">DATA DO EVENTO</label>
      <input type="text" class="form-control" name="evento_id" value=" {{$evento->id ?? old('id')}}">
    </div>
    </div>
	...
	<div id="cx3">222 {{$evento->id ?? old('id')}}</div>
	<div id="cx4">
    222eeeeee
    ffffffffffff
    @foreach ($pessoas as $pessoa)
